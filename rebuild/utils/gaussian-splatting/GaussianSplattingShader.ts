import { ShaderMaterialParameters, Texture, Vector2, IUniform, ShaderChunk, ShaderLib } from 'three'


interface GaussianSplattingMaterialParameters extends ShaderMaterialParameters {

    uniforms: {
        covariancesTexture: IUniform<Texture | null>,
        centersTexture: IUniform<Texture | null>,
        colorsTexture: IUniform<Texture | null>,
        focal: IUniform<Vector2>,
        basisViewport: IUniform<Vector2>
    }
}



// const GaussianSplattingShader: GaussianSplattingMaterialParameters = {
	
// 	defines: {},

// 	uniforms: {
//         covariancesTexture: { value: null },
...
const GaussianSplattingShader: GaussianSplattingMaterialParameters = {
	...
	// 2D covariance) that is ultimately rasterized
        ...
        void main () {
			...
			mat4 transformModelViewMatrix = viewMatrix * modelMatrix;
            ...
            vec2 ndcOffset = vec2(position.x * basisVector1 + position.y * basisVector2) * basisViewport * 2.0;
	...
	fragmentShader: /*glsl*/`
		...
		void main () {
            ...
            //vec4(color.rgb * u_Color, opacity * u_Opacity);
		}
	`
};
