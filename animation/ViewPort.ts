...
import { EffectComposer, OrbitControls, RoomEnvironment } from 'three/examples/jsm/Addons.js'
...
export default class ViewPort {
    ...
    createRenderer() {
        ...
        this.editor.composer = this.composer
    ...
    // 设置渲染的对象和方法
    setRenderOF(obj: { animate: () => void }): void {
        this.renderer.setAnimationLoop(obj.animate.bind(obj));
    }
